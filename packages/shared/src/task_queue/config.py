...
# packages/shared/src/task_queue/config.py
...
class CeleryConfig(BaseConfig):
    ...
    _exchange_type : str
        ...
        Default is "direct".
    _task_name_estimate : str
        Registered task name for 3D pose estimation pipeline execution.
        Default is "estimate".
    _task_name_visualize : str
        Registered task name for pose visualization rendering pipeline.
        Default is "visualize".
    """
    ...
    _task_name_estimate: Final[str] = "estimate"
    _task_name_visualize: Final[str] = "visualize"
