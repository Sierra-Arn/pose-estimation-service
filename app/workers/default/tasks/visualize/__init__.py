...
# app/workers/default/tasks/visualize/__init__.py
import shutil
import tempfile
...
def visualize_task(
    ...
    from ....task_infra.validator import validate_task_request
    from ....task_infra.tensors_io import load_pipeline_output
    from ....task_infra.frame_extractor import decode_video_stream_batches
    from .....shared.postgres import get_sync_db_session, Visualization
